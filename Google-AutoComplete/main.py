...
'''The function gets a dictionary and a search phrase.
The function tries to search for the sentence in the dictionary,
 with all possible changes, in the order of their score.
The function ends when 5 sentences are found'''
